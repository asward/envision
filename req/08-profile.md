...
08-R8: After loading a profile the system shall use the ENVISION_PROFILE
environment variable as the profile name for the active session.

08-R11: When no ENVISION_PROFILE envvar is found, the system shall use the filename (without extension) as the profile name and set the ENVISION_PROFILE env var accordingly.
...
08-R33: The system shall only support a single profile file at a time
